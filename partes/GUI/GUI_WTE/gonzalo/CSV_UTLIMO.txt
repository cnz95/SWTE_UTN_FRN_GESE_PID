...
vector<vector<string>> leerCSV(const string& archivo,char separador) {
...
void imprimir(vector<vector<string>> CSV)
{
...
int main() {
    ...
    cout<<"Incerte el simbolo con el que estan separados los datos del CSV a leer:";
    char separador;
    cin>>separador;
    CSV=leerCSV("D:/Descargas/rotor.csv",separador);
    imprimir(CSV);
    return 0;
}
