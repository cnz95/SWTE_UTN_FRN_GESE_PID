...
const analog_in AN_IN_TORQUE = analog_in::in0; // torque an0
const analog_in AN_IN_OMEGA = analog_in::in1; // omega an1
const analog_out AN_OUT_TORQUE = analog_out::out0; // setpoint torque an0
const digital_out D_O_ENABLE = digital_out::out0; // enable do0 REVISAR!!!
const digital_out D_O_TURN_LEFT = digital_out::out1; // turn left REVISAR!!!
const digital_out D_O_TURN_RIGHT = digital_out::out2; // turn right REVISAR!!!
